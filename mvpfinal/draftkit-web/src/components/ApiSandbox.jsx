      ...
      <div className="sandbox-endpoint-bar">
        <div className="endpoint-left">
          ...
          <div>
            ...
            <span className="endpoint-url">{VALUATION_DISPLAY_URL}/v1/valuate</span>
          </div>
        </div>
        <div className="endpoint-auth-block">
          <span className="endpoint-label">AUTH</span>
          <span className="endpoint-auth">Licensed inside the Dark Blue Valuation API product</span>
        </div>
        ...
        <div className="sandbox-panel">
          ...
          {apiStatus === "offline" && (
            <p style={{ fontSize: 10, color: "var(--red)", textAlign: "center", marginTop: 6 }}>
              Draft Kit backend or valuation service is offline. Start the local backend from <code>mvpfinal/draftkit-api</code>.
            </p>
          )}
        </div>
