...
const { buildDemoUpdatePayload } = require("../services/playerUpdateDemo");
const {
  createPlayerUpdate,
  listPlayerUpdates,
...
router.post("/demo", requireApiKey, (req, res) => {
  try {
     ...
     * live-feed ingestion. The caller chooses a player and alert_status; this
     * route only fills in a complete, readable update body for demonstrations.
     */
