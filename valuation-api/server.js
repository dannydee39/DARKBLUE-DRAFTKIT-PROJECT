...
<head>
  ...
  <title>Dark Blue MLB Valuation API</title>
...
<div class="page">
  ...
  <header class="site-header">
    ...
    <h1 class="site-title">MLB Valuation <span>API</span></h1>
    <p class="site-sub">
      Licensed MLB player-data and valuation engine for fantasy baseball auction drafts.
  ...
  <!-- ── Footer ────────────────────────────────────────────────────────────── -->
  <footer class="footer">
    <div>Dark Blue MLB Valuation API &nbsp;·&nbsp; v1.0.0 &nbsp;·&nbsp; Licensed Fantasy Baseball Draft Intelligence</div>
